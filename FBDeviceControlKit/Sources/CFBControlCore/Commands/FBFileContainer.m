...
- (FBFuture<FBFuture<NSNull *> *> *)tail:(NSString *)path toConsumer:(id<FBDataConsumer>)consumer
{
  return [[[self
    ...
    onQueue:self.queue fmap:^ FBFuture<FBManagedProcess<NSNull *, id<FBDataConsumer>, NSData *> *> * (id<FBContainedFile> fileToTail) {
    ...
    onQueue:self.queue map:^(FBManagedProcess *process) {
