 ...
 */
@property (nonatomic, strong, readonly) FBManagedProcess *process;
 ...
 */
- (instancetype)initWithProcess:(FBManagedProcess *)process consumer:(id<FBDataConsumer>)consumer queue:(dispatch_queue_t)queue;
